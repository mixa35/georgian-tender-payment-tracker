...
- Downloads `input-report.xlsx` from OneDrive
...
Default settings live in [config/settings.yaml](config/settings.yaml).
...
The scheduled/manual workflow lives at [.github/workflows/tender_tracker.yml](.github/workflows/tender_tracker.yml).
...
For local development or emergency fallback, use [scripts/run_tender_tracker.ps1](scripts/run_tender_tracker.ps1).
